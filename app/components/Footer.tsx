  ...
  return (
    <footer style={{ position: 'fixed', bottom: 0, left: 0, right: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', fontSize: 'clamp(11px, 2.5vw, 12px)', color: 'rgba(255, 255, 255, 0.6)', padding: '12px 20px', background: 'linear-gradient(to top, rgba(17, 24, 39, 0.95), transparent)', backdropFilter: 'blur(10px)', zIndex: 100 }}>
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '8px 20px' }}>
        ...
        <span style={{ color: 'rgba(255, 255, 255, 0.3)', userSelect: 'none' }}>•</span>
        <a href="https://github.com/Teycir/honeypotscan#readme" target="_blank" rel="noopener noreferrer" style={linkStyle} onMouseEnter={(e) => Object.assign(e.currentTarget.style, linkFocusStyle)} onMouseLeave={(e) => Object.assign(e.currentTarget.style, linkStyle)} onFocus={(e) => Object.assign(e.currentTarget.style, linkFocusStyle)} onBlur={(e) => Object.assign(e.currentTarget.style, linkStyle)}>Source Code</a>
        <span style={{ color: 'rgba(255, 255, 255, 0.3)', userSelect: 'none' }}>•</span>
      ...
      <div style={{ display: 'flex', gap: '12px', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <a href="https://www.reddit.com/submit?url=https://honeypotscan.pages.dev&title=HoneypotScan%20-%20Free%20Crypto%20Scam%20Detection" target="_blank" rel="noopener noreferrer" style={{ ...linkStyle, display: 'flex', alignItems: 'center', padding: '4px' }} onMouseEnter={(e) => Object.assign(e.currentTarget.style, linkFocusStyle)} onMouseLeave={(e) => Object.assign(e.currentTarget.style, linkStyle)} onFocus={(e) => Object.assign(e.currentTarget.style, linkFocusStyle)} onBlur={(e) => Object.assign(e.currentTarget.style, linkStyle)} aria-label="Share on Reddit">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://honeypotscan.pages.dev" target="_blank" rel="noopener noreferrer" style={{ ...linkStyle, display: 'flex', alignItems: 'center', padding: '4px' }} onMouseEnter={(e) => Object.assign(e.currentTarget.style, linkFocusStyle)} onMouseLeave={(e) => Object.assign(e.currentTarget.style, linkStyle)} onFocus={(e) => Object.assign(e.currentTarget.style, linkFocusStyle)} onBlur={(e) => Object.assign(e.currentTarget.style, linkStyle)} aria-label="Share on LinkedIn">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
